...
export const LOGIN_EXPRESS_REQUEST = 'app/RegisterPage/LOGIN_EXPRESS_REQUEST';
export const LOGIN_EXPRESS_SUCCESS = 'app/RegisterPage/LOGIN_EXPRESS_SUCCESS';
export const LOGIN_EXPRESS_ERROR = 'app/RegisterPage/LOGIN_EXPRESS_ERROR';
